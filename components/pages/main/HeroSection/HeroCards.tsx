...
import { socialmidia } from "@/data/midias";
    ...
    <div className="hidden lg:flex flex-row flex-wrap gap-8 relative w-[700px] h-[500px]">
      ...
      <Card className="absolute w-[340px] box-shadow gap-0">
        <CardHeader className="flex flex-row items-center gap-4 pb-2">
          ...
          <div className="flex flex-col">
            <CardTitle className="text-lg">Automação Residencial</CardTitle>
            <CardDescription>@arduhomeofc</CardDescription>
          </div>
        </CardHeader>
      ...
      <Card className="absolute right-[20px] top-12 w-80 flex flex-col justify-center items-center box-shadow">
        <CardHeader className="mt-6 flex justify-center items-center">
          ...
          <div className="whitespace-nowrap pt-3">
            <CardTitle className="text-center">Ardu Home</CardTitle>
            <CardDescription className="font-normal text-primary mt-1">
        ...
        <CardFooter>
          <div>
            {socialmidia.map((social) => (
              ...
              >
                <Icon icon={social.icon} width="60" height="40" />
              </a>
            ))}
          </div>
        </CardFooter>
      ...
      <Card className="absolute w-[340px] -right-[0px] bottom-[35px]  box-shadow">
        <CardHeader className="space-y-1 flex md:flex-row justify-start items-start gap-4">
          ...
          <div>
            <CardTitle>Changing Your Idea</CardTitle>
